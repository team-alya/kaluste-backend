...
TÄRKEÄÄ: Älä koskaan arvaa huonekalun merkkiä tai mallia, jos et ole suhteellisen varma tunnistuksestasi. Jos et pysty tunnistamaan merkkiä tai mallia kuvasta luotettavasti, palauta arvoksi "Ei tiedossa". On parempi jättää tieto tyhjäksi kuin antaa virheellinen tieto.
`;
